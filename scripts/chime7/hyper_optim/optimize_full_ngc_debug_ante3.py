...
OUTPUT_DIR = "/ws/chime7_outputs/optuna-msdd-gss-asr5-trial221-ante3"
...
def objective_gss_asr(
    ...
    mc_mask_min_db = trial.suggest_int("mc_mask_min_db", -200, -200, 20)
    mc_postmask_min_db = trial.suggest_int("mc_postmask_min_db", -15, -15, 3)
    bss_iterations = trial.suggest_int("bss_iterations", 15, 15, 5)
    dereverb_filter_length = trial.suggest_int("dereverb_filter_length", 5, 5, 5)
    normalize_db = trial.suggest_int("normalize_db", -35, -35, 5)
