...
def __process_data(
    ...
    if len(not_found_wavs) > 0:
        skipped_not_found_file = unzipped_dataset_path.parent / "skipped_not_found_wavs.list"
    ...
    if len(wrong_duration_wavs) > 0:
        skipped_wrong_duration_file = unzipped_dataset_path.parent / "skipped_wrong_duration_wavs.list"
...
def main():
    ...
    entries_train, entries_val, entries_test = __process_data(
