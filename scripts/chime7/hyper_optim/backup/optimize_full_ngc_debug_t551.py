...
OUTPUT_DIR = "/ws/chime7_outputs/optuna-msdd-gss-asr5-trial551"
...
def diar_config_setup(
    ...
    config.diarizer.vad.parameters.frame_vad_threshold = 0.2 #trial.suggest_float("frame_vad_threshold", 0.23, 0.23, step=0.005)
    ...
    config.diarizer.vad.parameters.min_duration_off = 0.6 # round(trial.suggest_float("min_duration_off", 0.95, 0.95, step=0.05), 2)

    # MSDD Optimization
    config.diarizer.msdd_model.parameters.sigmoid_threshold = [0.8]
    ...
    r_value = 0.45  #round(trial.suggest_float("r_value", 1.7, 1.7, step=0.05), 4)
...
def objective_gss_asr(
    ...
    mc_mask_min_db = -140  #trial.suggest_int("mc_mask_min_db", -160, -160, 20)
