...
OUTPUT_DIR = "/ws/chime7_outputs/optuna-msdd-gss-asr5-trial221-ante2"
...
def objective_gss_asr(
    ...
    mc_postmask_min_db = trial.suggest_int("mc_postmask_min_db", -6, -6, 3)
    ...
    dereverb_num_iterations = trial.suggest_categorical("dereverb_num_iterations", choices=[10])
