...
DIARIZATION_CONFIG=${3:-system_vA04D} # for example, system_vA01
DIARIZATION_BASE_DIR=${4:-"/media/data2/chime7-challenge/chime7_diar_results"} # for example, ${HOME}/scratch/chime7/chime7_diar_results
DIA_OVERLAP_DIR="pred_rttms_T0.98"
...
# Manual path setup
# =================
espnet_root="/home/heh/github/espnet/egs2/chime7_task1/asr1" # For example, ${HOME}/work/repos/espnet-mirror/egs2/chime7_task1/asr1
chime7_root="/media/data2/chime7-challenge/datasets/chime7_official_cleaned_v2" # For example, /data/chime7/chime7_official_cleaned
...
echo "python convert_diarization_result_to_falign.py --diarization-dir $diarization_output_dir"
...
do
    ...
    echo "python ${espnet_root}/local/get_lhotse_manifests.py -c $chime7_root \
        -d $scenario \
        -p $subset \
