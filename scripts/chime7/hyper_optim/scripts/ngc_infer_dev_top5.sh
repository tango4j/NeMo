...
TRIAL_ID=323
NGC_JOB_NAME=chime7-infer-t${TRIAL_ID}-dev
OPTUNA_JOB_NAME=optuna-msdd-gss-asr5-dev
SCRIPT_NAME=optimize_full_ngc_debug_t${TRIAL_ID}.py

OPTUNA_LOG=${OPTUNA_JOB_NAME}.log
STORAGE=sqlite:///${OPTUNA_JOB_NAME}.db
DIAR_BATCH_SIZE=11
OUTPUT_DIR="/ws/chime7_outputs/optuna-msdd-gss-asr5-trial${TRIAL_ID}-dev"
