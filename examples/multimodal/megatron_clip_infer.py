...
from nemo.collections.multimodal.data.clip.clip_dataset import tokenize, get_preprocess_fns
...
def main(cfg) -> None:
    ...
    with torch.no_grad():
        ...
        texts = text_transform(cfg.texts)
    ...
    if is_global_rank_zero:
        print(f"Given image's CLIP text probability: ", list(zip(cfg.texts, text_probs)))
