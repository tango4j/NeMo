...
def diar_config_setup(
    ...
    config.diarizer.vad.model_path = vad_model_path
    if tune_vad: 
        config.diarizer.vad.parameters.frame_vad_threshold = trial.suggest_float("frame_vad_threshold", 0.2, 0.6, step=0.005)
        config.diarizer.vad.parameters.pad_onset = round(trial.suggest_float("pad_onset", 0.0, 0.2, step=0.025), 3)
        config.diarizer.vad.parameters.pad_offset = round(trial.suggest_float("pad_offset", 0.0, 0.2, step=0.025), 3)
