...
scenario=chime6 # mixer6 dipco chime6
subset=dev
...
do
    ...
    do
        data_dir=/home/ajukic/work/repos/nemo-taejin/scripts/chime7/process/${tag}/${diarization_config}/${scenario}/${subset}/${tuning}/
        ...
        CUDA_VISIBLE_DEVICES=0 python transcribe_speech.py \
            ...
            output_filename="nemo_experiments/nemo_chime6_ft_rnnt/${tag}/${diarization_config}/${tuning}/${scenario}/"
    done
done