...
SYSTEM=${3:-"system_vB02_D03-T0.9"} # select system to run, e.g., system_vA04D, system_vA01
...
do
    ...
    python transcribe_speech.py \
        ...
        output_filename="nemo_experiments/nemo_${SYSTEM}_chime6_ft_rnnt_v2/${scenario}/"
done
done