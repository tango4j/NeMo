...
class FastPitchModel(SpectrogramGenerator, Exportable, FastPitchAdapterModelMixin):
    ...
    def __init__(self, cfg: DictConfig, trainer: Trainer = None):
        ...
        prosody_loss_scale = 0.1 if self.learn_alignment else 1.0
        dur_loss_scale = cfg.get("dur_loss_scale", prosody_loss_scale)
        pitch_loss_scale = cfg.get("pitch_loss_scale", prosody_loss_scale)
        energy_loss_scale = cfg.get("energy_loss_scale", prosody_loss_scale)
