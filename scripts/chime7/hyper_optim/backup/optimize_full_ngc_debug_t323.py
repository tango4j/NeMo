...
OUTPUT_DIR = "/ws/chime7_outputs/optuna-msdd-gss-asr5-trial323"
...
def diar_config_setup(
    ...
    config.diarizer.vad.parameters.frame_vad_threshold = 0.25 
    config.diarizer.vad.parameters.pad_onset = 0.15  
    config.diarizer.vad.parameters.pad_offset = 0.4 
    config.diarizer.vad.parameters.min_duration_on = 0.45 
    config.diarizer.vad.parameters.min_duration_off = 0.8

    # MSDD Optimization
    config.diarizer.msdd_model.parameters.sigmoid_threshold = [0.9]
    config.diarizer.msdd_model.parameters.global_average_mix_ratio = 0.65  
    ...
    r_value = 1.2  #round(trial.suggest_float("r_value", 1.7, 1.7, step=0.05), 4)
